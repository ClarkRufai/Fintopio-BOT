...
class Fintopio:
    ...
    def welcome(self):
        print(
            f"""
        {Fore.GREEN + Style.BRIGHT}Fintopio Script by {Fore.BLUE + Style.BRIGHT}HACKER WORLD BD
            """
            f"""
        {Fore.GREEN + Style.BRIGHT}Join here:- {Fore.YELLOW + Style.BRIGHT}https://t.me/HACKER_WORLD_BD
            """
        )
